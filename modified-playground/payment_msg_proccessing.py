...
teams = ("Hippo", "ORCA", "NZAPP")


@udf(input_types=[DataTypes.STRING()], result_type=DataTypes.STRING())
def teams_id_to_name(id):
    return teams[id]
...
def log_processing():
    ...
    t_env.register_function('teams_id_to_name', teams_id_to_name)

    t_env.from_path("payment_msg") \
        .select("teams_id_to_name(teamId) as team, payAmount") \
        .group_by("team") \
        .select("team, sum(payAmount) as pay_amount") \
